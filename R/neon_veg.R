...
process.veg("25-099.1.xls")
process.veg("25-099.2.xls")
process.veg("25-099.3.xls")
process.veg("25-099.4-25-096.5.xls")
process.veg("25-068.2.xls")
process.veg("25-171.1.xls")
process.veg("25-171.2.xls")
process.veg("25-171.3.xls")
process.veg("25-170.xls")
...
report.veg("manifest_for_D0520250327160403804-25-099.csv", TRUE)
...
report.veg("manifest_for_D1120250428134140455-25-171.csv") # one reanalysis
